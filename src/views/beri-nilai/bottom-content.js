            ...
            <Table responsive className="table-outline mb-0 d-none d-sm-table custom-table">
              <thead className="thead-light">
                <tr>
                  ...
                  <th>Nilai</th>
                  <th className="text-left">Beri Nilai</th>
                  <th>Rincian</th>
                </tr>
              </thead>
              <tbody className="">
                ...
                <tr className="tbody-table-nilai spacer highlighted">
                  <td className="text-left left-col label">
                  ...
                  <td ><FontAwesome name="pencil" size="lg" /></td>
                  <td ><FontAwesome name="ellipsis-h" size="lg" /></td>
                </tr>
                <tr><th></th></tr>
                <tr className="tbody-table-nilai label">
                  <td className="text-left  &__left-col">
                    <div className="col-sm-7 avatar">
                      <Avatar src={Ava} size="40" round={true} />
                    </div>
                    <div className="col-sm-2">
