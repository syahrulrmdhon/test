    ...
    return (
      <div className="row">
        ...
        <div className="col-sm-6">
          <input type="text" className="form-control create-exam__input create-exam__input-amount" onChange={(event) => this.props.handleEvent(event.target.value, 'content', this.state.step, this.props.order)} placeholder="Berikan Jawaban" value={this.choices()[this.props.order] ? this.choices()[this.props.order].content : ''}/>
        </div>
