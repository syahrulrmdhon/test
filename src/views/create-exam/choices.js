    ...
    return (
        <div className="row">
          ...
          <div className="col-sm-3 create-exam__choice pl-0">
            <input className="create-exam__radio" type="radio" name={this.props.id} value="Opsi Benar" name="choices" id={this.props.id} onChange={(event) => this.props.changed(event, 'is_correct_ans', this.props.id)} checked={this.props.id === this.props.correctAnswer}/>
            <label htmlFor={this.props.id}>Opsi Benar</label>
          </div>
        </div>
    )
  }
